...
// speadsheets id
const _spreadsheetsId = '1YFKXMO_FCEs2m4B9m5aVTPAmGQYaCc-JatAq4cMLwt4';

void main() async {
  // init gsheets
  final gsheets = GSheets(_credentials);

  // fetch speadsheets id
  final ss = await gsheets.spreadsheet(_spreadsheetsId);

  // get worksheet by title
  var summery = ss.worksheetByTitle('summery');

  // update a cell
  await summery!.values.insertValue(
    'Soikat',
    column: 2,
    row: 2,
  );
